function [snr1,BERcanal] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [SNR1,BERCANAL] = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   [SNR1,BERCANAL] = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [snr1,BERcanal] = importfile('FM 16QAM 50 kmh Eq mmse con dft.txt',1, 18);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/11 09:53:05
